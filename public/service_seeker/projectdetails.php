										...
										<tr>
                                           ...
                                           <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                        ...
                                                        echo '<a href="http://localhost/seralance/'.$_SESSION['projectDetails']['file'].'" download>Download</a>' ;
                                                        }
                                                        else{
                                         ...
                                         <tr>
                                                ...
                                                <?php 
                                                    ...
                                                    echo '<a href="http://localhost/seralance/'.$_SESSION['projectDetails']['delivered_file'].'" download>Download</a>' ;
                                                    }
                                                    else{
