         ...
         <div class="jumbotron bg-light " style="padding-top: 25px; background-color:rgb(204,229,255,0.5);">
            ...
            <div class="form-group row  mt-4"  >
               <div class="form-inline" style=" border-style:outset;">
                  ...
                  <div class="col-sm-5">
                     <span style="font-style:italic;font-weight:bolder;"> ETB 150.00 </span> 
                  </div>
                  <div class="col-sm-5">
               ...
               <table id = "table" class = "table table-bordered table-striped">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><a class = "btn btn-warning" href = "edit_room.php?room_id=<?php echo $fetch['room_id']?>">
                           <i class = "fa fa-edit"></i> </a> 
                        </td>
                        <td>
                           <a class = "btn btn-danger" onclick =
                              "confirmationDelete(this); return false;" 
                              href = "delete_room.php?room_id=<?php echo $fetch['room_id']?>"><i class =
                              "fa fa-trash"></i></a>
                        </td>
                     </tr>
                     <?php
