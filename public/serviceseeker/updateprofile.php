...
<html>
   ...
   <body>
               ...
               <div class="col-sm-3 ">
                  <div class="form-group text-center mr-5">
                     ...
                     <div class="input-group">
                        <img src="../Image/profile.jpg" id="output" class="img-rounded" alt="No photo to view" 
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control form-control-sm ml-5" id="colFormLabelSm" placeholder="Account number">
    </div>
  </div>
</div>
 </div>
