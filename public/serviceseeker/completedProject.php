...
<head>
   ...
   <script>
      document.title="Service seeker-completed project";
   </script>
</head>
   ...
   <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12 ">
         <div class="jumbotron bg-light " style="padding-top: 25px; background-color:rgb(204,229,255,0.5);">
            <h3 class="text-primary mb-5" style="text-decoration:underline;"> Completed Projects </h3>
            <!-- claim fund -->
                     ...
                     <td><?php echo $fetch['No']?></td>
                        ...
                        <td>
                           <a class = "btn btn-danger" onclick =
                              ...
                              href = "delete_room.php?room_id=<?php echo $fetch['room_id']?>">Rate</a>
                        </td>
                     </tr>
                     <?php
                        }
