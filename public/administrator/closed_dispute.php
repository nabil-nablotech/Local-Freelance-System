...
<head>
  ...
  <script>
    document.title="Admin-closed disputes";
</script>
</head>
 ...
 <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">closed disputes </h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="./">Home</a>
              </li>
              <li class="breadcrumb-item">Disputes</li>
              <li class="breadcrumb-item active" aria-current="page">closed disputes </li>
            </ol>
          </div>
          <div class="row">
            <!-- Alerts Basic -->
            <div class="col-lg-12">
              <div class="card shadow-sm mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">List of closed disputes</h6>
                </div>
                <div class="card-body">
<!--  -->
                <!--  -->
