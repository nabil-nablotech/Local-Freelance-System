			...
			<div class="col-sm-12 col-md-12 col-lg-12 ">
				<div class="card shadow-sm mb-4">
					<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
						<h6 class="m-0 font-weight-bold text-primary mx-auto">List of open tickets</h6> </div>
					<div class="card-body">
						<!--  -->
								...
								<tbody>
                                       ...
                                       echo <<<EOT
                                                ...
                                                <!--  -->
                                                   ...
                                                   <td><a class="btn btn-success" href="http://localhost/seralance/public/admin/reply/{$ticket['ticket_id']}">Reply</a> </td>
                                                <!--  -->
                                                </tr>
                                             EOT;
														$count++ ;
