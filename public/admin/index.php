...
<head>
  ...
  <title>Serelance Admin - Dashboard</title>
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" style="color:black !important;;">
      ...
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="form_basics.html">Completed projects</a>
            <a class="collapse-item" href="form_advanceds.html">Ongoing Projects</a>
            <a class="collapse-item" href="form_advanceds.html">Announced  Projects</a>
            <a class="collapse-item" href="form_advanceds.html">Offered Projects</a>
            <a class="collapse-item" href="form_advanceds.html">Terminated Projects</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="simple-tables.html">Transaction history</a>
            <a class="collapse-item" href="datatables.html">Transferred funds</a>
            <a class="collapse-item" href="datatables.html">Fund Transfer requests</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div id="collapsedispute" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="simple-tables.html">Open Disputes</a>
            <a class="collapse-item" href="datatables.html">Closed Dsputes</a>
          </div>
        </div>
      </li>
      <!--  -->
      <li class="nav-item">
        ...
        <div id="collapseTicket" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="simple-tables.html">Open Ticket</a>
            <a class="collapse-item" href="datatables.html">Closed Ticket</a>
          </div>
        </div>
      </li>
<!--  -->
      <li class="nav-item">
        ...
        <div id="collapsepolicy" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="simple-tables.html">View policy</a>
            <a class="collapse-item" href="datatables.html">Edit policy</a>
          </div>
        </div>
      </li>
      <!--  -->
      ...
      <li class="nav-item">
        ...
        <div id="collapsefaq" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="simple-tables.html">View FAQS</a>
            <a class="collapse-item" href="datatables.html">Edit FAQS</a>
          </div>
        </div>
      </li>
